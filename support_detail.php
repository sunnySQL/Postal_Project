...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header("Location: " . ($_SESSION['role'] == 'Customer' ? "support.php" : "employee_dashboard.php"));
    exit();
}
...
// Redirect to the proper ticket view page with the same ID
header("Location: support/view_ticket.php?id=" . $ticket_id);
exit();
?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div class="md:col-span-2">
                ...
                <section class="bg-white shadow-sm p-6 rounded-lg mb-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg mb-6">
                        ...
                        <p class="mt-2">
                            <span class="font-semibold">Related Package:</span> 
                    ...
                    <div>
                        ...
                        <form action="support_detail.php?id=<?= $ticket_id ?>" method="post" class="mt-4">
                            <div class="mb-4">
            ...
            <div>
                ...
                <section class="bg-white shadow-sm p-6 rounded-lg mb-6">
                    ...
                    <form action="support_detail.php?id=<?= $ticket_id ?>" method="post">
                        <div class="mb-4">
